...
def main():
    ...
    df_input_file = df_input_file.fillna(df_input_file.mean()["one":"two"], inplace=False)
    print("REPLACE NAN VALUES WITH THE MEAN VALUE IN COLUMNS ONE AND TWO:")
    print(df_input_file)       
    print()
    
    df_input_file = df_input_file.fillna(df_input_file.median()["three"], inplace=False)
